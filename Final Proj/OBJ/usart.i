...
{      
	...
	((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR = (u8) ch;      
	}
	else
	{	
...
void usart1_send(u8 data)
{
	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR = data;
	while((((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR&0x40)==0);	
}
void uart_init(u32 pclk2,u32 bound)
{  	 
	...
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR|=1<<14;  
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH&=0XFFFFF00F;
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH|=0X000008B0;
		  
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2RSTR|=1<<14;   
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2RSTR&=~(1<<14);
	
 	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->BRR=mantissa; 
	((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->CR1|=0X200C;  
