#line 1 "..\\HARDWARE\\USART3\\usart3.c"
...
#line 1 "..\\HARDWARE\\USART3\\usart3.h"
#line 9 "..\\HARDWARE\\USART3\\usart3.h"
...
#line 3 "..\\HARDWARE\\USART3\\usart3.c"
u8 Usart3_Receive;
 u8 mode_data[8];
 u8 six_data_stop[3]={0X59,0X59,0X59};  
...
{  	 
  ...
  mantissa<<=4;
	...
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR|=1<<18;  
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH&=0XFFFF00FF; 
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH|=0X00008B00;
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->ODR|=1<<10;	  
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1RSTR|=1<<18;   
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1RSTR&=~(1<<18);
	
 	((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->BRR=mantissa; 
	((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1|=0X200C;  
	
	((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1|=1<<8;    
	((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->CR1|=1<<5;    
	MY_NVIC_Init(2,1,USART3_IRQn,2);
}
...
void USART3_IRQHandler(void)
{	
	if(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->SR&(1<<5))
	{	  
	 static	int uart_receive=0;
	 uart_receive=((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR; 
	 mode_data[0]=uart_receive;
		...
		if(uart_receive==0x59)  Flag_sudu=2;  
		if(uart_receive==0x58)  Flag_sudu=1;  
		
	  if(uart_receive>10)  
    {			
			if(uart_receive==0x5A)	Flag_Qian=0,Flag_Hou=0,Flag_Left=0,Flag_Right=0;
			else if(uart_receive==0x41)	Flag_Qian=1,Flag_Hou=0,Flag_Left=0,Flag_Right=0;
		...
		{			
			Flag_sudu=1;
			if(uart_receive==0x00)	Flag_Qian=0,Flag_Hou=0,Flag_Left=0,Flag_Right=0;
			else if(uart_receive==0x01)	Flag_Qian=1,Flag_Hou=0,Flag_Left=0,Flag_Right=0;
