...
{   
    Vol=(float)Voltage/100;
		...
		DataScope_Get_Channel_Data( Distance/10, 2 );         
		DataScope_Get_Channel_Data( Vol, 3 );                 
		...
		((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR = DataScope_OutPut_Buffer[i]; 
		}
}
