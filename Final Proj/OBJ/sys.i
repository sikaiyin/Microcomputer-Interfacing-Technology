...
void MY_NVIC_SetVectorTable(u32 NVIC_VectTab, u32 Offset)	 
{ 	   	 
	((SCB_Type *) ((0xE000E000) + 0x0D00))->VTOR = NVIC_VectTab|(Offset & (u32)0x1FFFFF80);
...
{ 
	...
	temp1<<=8;
	temp=((SCB_Type *) ((0xE000E000) + 0x0D00))->AIRCR;  
	temp&=0X0000F8FF; 
	temp|=0X05FA0000; 
	temp|=temp1;	   
	((SCB_Type *) ((0xE000E000) + 0x0D00))->AIRCR=temp;  
}
...
{ 
	...
	temp&=0xf;
	((NVIC_Type *) ((0xE000E000) + 0x0100))->ISER[NVIC_Channel/32]|=(1<<NVIC_Channel%32);
	((NVIC_Type *) ((0xE000E000) + 0x0100))->IP[NVIC_Channel]|=temp<<4;
} 
...
void Ex_NVIC_Config(u8 GPIOx,u8 BITx,u8 TRIM) 
{
	...
	((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[EXTADDR]&=~(0x000F<<EXTOFFSET);
	((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[EXTADDR]|=GPIOx<<EXTOFFSET;
	
	((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR|=1<<BITx;
	
 	if(TRIM&0x01)((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTSR|=1<<BITx;
	if(TRIM&0x02)((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTSR|=1<<BITx;
} 	  
