...
void TIM3_Cap_Init(u16 arr,u16 psc)	
{	 
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1ENR|=1<<1;     
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR|=1<<3;    	
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL&=0XFFFFFF00; 
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL|=0X00000028;
	
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->ARR=arr;  		
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->PSC=psc;  		
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCMR2|=1<<0;	
 	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCMR2|=0<<4; 	
 	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCMR2|=0<<2; 	

	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCER|=0<<9; 	
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCER|=1<<8; 	

	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->DIER|=1<<3;   
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->DIER|=1<<0;   
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CR1|=0x01;    
...
void Read_Distane(void)
{   
	 *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(1<<2))))=1;
	 delay_us(15);  
	 *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(1<<2))))=0;	
...
{ 		    		  			    
	u16 tsr;
	tsr=((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->SR;
	if((TIM3CH3_CAPTURE_STA&0X80)==0)
				{
				    	...
				    	{	
											...
											{	  			
											TIM3CH3_CAPTURE_STA|=0X80;		
											TIM3CH3_CAPTURE_VAL=((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR3;	
											((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCER&=~(1<<9);			
									  	}else  								
				   	{
											TIM3CH3_CAPTURE_STA=0;			
											TIM3CH3_CAPTURE_VAL=0;
											TIM3CH3_CAPTURE_STA|=0X40;		
											((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CNT=0;					
											((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCER|=1<<9; 				
							}		    
					    	}			     	    					   
		   }
