...
void KEY_Init(void)
{
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH&=0X0FFFFFFF; 
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRH|=0X80000000;
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->ODR|=1<<15; 
} 
...
u8 click_N_Double (u8 time)
{
	  ...
	  if(*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) &0xFFFFF)<<5)+(15<<2))))==0)  Forever_count++;   
     else        Forever_count=0;
		if(0== *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) &0xFFFFF)<<5)+(15<<2))))&&0==flag_key)		flag_key=1;	
	  if(0==count_key)
		{
				if(flag_key==1) 
				{
		...
		if(1== *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) &0xFFFFF)<<5)+(15<<2)))))			flag_key=0,count_key=0;
...
u8 click(void)
{
			...
			if(flag_key&& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) &0xFFFFF)<<5)+(15<<2))))==0)
			{
			flag_key=0;
			return 1;	
			}
			else if(1== *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) &0xFFFFF)<<5)+(15<<2)))))			flag_key=1;
			return 0;
}
...
u8 Long_Press(void)
{
	    ...
	    if(Long_Press==0&& *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0800)+8) &0xFFFFF)<<5)+(15<<2))))==0)  Long_Press_count++;   
