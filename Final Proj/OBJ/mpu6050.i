#line 1 "..\\BALANCE\\MPU6050\\MPU6050.c"
...
#line 2 "..\\BALANCE\\MPU6050\\MPU6050.c"
#line 3 "..\\BALANCE\\MPU6050\\MPU6050.c"
#line 4 "..\\BALANCE\\MPU6050\\MPU6050.c"
#line 15 "..\\BALANCE\\MPU6050\\MPU6050.c"
...
void MPU6050_setClockSource(uint8_t source){
    IICwriteBits(0xD0, 0x6B, 2, 3, source);
...
void MPU6050_setFullScaleGyroRange(uint8_t range) {
    IICwriteBits(0xD0, 0x1B, 4, 2, range);
}
...
void MPU6050_setFullScaleAccelRange(uint8_t range) {
    IICwriteBits(0xD0, 0x1C, 4, 2, range);
}
...
void MPU6050_setSleepEnabled(uint8_t enabled) {
    IICwriteBit(0xD0, 0x6B, 6, enabled);
}
...
uint8_t MPU6050_getDeviceID(void) {
    ...
    IICreadBytes(0xD0, 0x75, 1, buffer);
    return buffer[0];
}
...
void MPU6050_setI2CMasterModeEnabled(uint8_t enabled) {
    IICwriteBit(0xD0, 0x6A, 5, enabled);
}
...
void MPU6050_setI2CBypassEnabled(uint8_t enabled) {
    IICwriteBit(0xD0, 0x37, 1, enabled);
}
...
{ 
   ...
   i2cRead(0x68,0x75,1,temp);
	...
	if(!mpu_init())
  {
	  if(!mpu_set_sensors(((0x40) | (0x20) | (0x10)) | (0x08)))
	  	 printf("mpu_set_sensor complete ......\r\n");
	  if(!mpu_configure_fifo(((0x40) | (0x20) | (0x10)) | (0x08)))
	  ...
	  if(!dmp_enable_feature((0x010) | (0x001) |
	        (0x002) | (0x040) | (0x100) |
	        (0x020)))
...
{	   
	  float Temp;
	  Temp=(I2C_ReadOneByte(0xD0,0x41)<<8)+I2C_ReadOneByte(0xD0,0x42);
