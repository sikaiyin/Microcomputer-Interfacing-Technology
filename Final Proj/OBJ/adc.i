...
{    
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->CRL&=0XFFF0FFFF;
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR|=1<<9;    
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2RSTR|=1<<9;   
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2RSTR&=~(1<<9);
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR&=~(3<<14);   
	
	
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR|=2<<14;      	 
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR1&=0XF0FFFF;   
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR1|=0<<16;      
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR1&=~(1<<8);    
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2&=~(1<<1);    
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2&=~(7<<17);	   
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2|=7<<17;	   
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2|=1<<20;      
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2&=~(1<<11);   
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->SQR1&=~(0XF<<20);
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->SQR1&=0<<20;     
	
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->SMPR2&=0XFFF0FFFF; 
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->SMPR2|=7<<12;      

	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2|=1<<0;	    
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2|=1<<3;        
	while(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2&1<<3);  
    
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2|=1<<2;        
	while(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2&1<<2);  
}		
...
u16 Get_Adc(u8 ch)   
{
	...
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->SQR3&=0XFFFFFFE0;
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->SQR3|=ch;		  			    
	((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->CR2|=1<<22;       
	while(!(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->SR&1<<1));
	return ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400))->DR;		
}
...
{  
	int Volt;
	Volt=Get_Adc(4)*3.3*11.5*100/1.5/4096;	
	return Volt;
}
