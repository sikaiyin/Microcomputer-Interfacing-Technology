...
{	
	u8 i;			  
	if(cmd)
	  *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(4<<2))))=1;
	else 
	  *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(4<<2))))=0;		  
	for(i=0;i<8;i++)
	{			  
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(15<<2))))=0;
		if(dat&0x80)
		   *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(14<<2))))=1;
		else 
		   *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(14<<2))))=0;
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(15<<2))))=1;
		dat<<=1;   
	}				 		  
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(4<<2))))=1;   	  
} 
...
{ 	
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL&=0XFFF0FFFF; 
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRL|=0X00020000;

  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR|=1<<4;     	
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR|=1<<0;     	
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRH&=0X000FFFFF;	
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRH|=0X22200000; 
	((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR|=1<<8;	
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR&=0xFFFFFFFE;	
	((BKP_TypeDef *) (((uint32_t)0x40000000) + 0x6C00))->CR&=0xFFFFFFFE; 	
	((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CR&=0xFFFFFEFF;	

	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(13<<2))))=0;
	delay_ms(100);
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(13<<2))))=1; 
