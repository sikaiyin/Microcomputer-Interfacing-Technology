...
void delay_init(u8 SYSCLK)
{
 	...
 	((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL&=~(1<<2);	
	fac_us=SYSCLK/8;		
	    
#line 44 "..\\SYSTEM\\delay\\delay.c"
	fac_ms=(u16)fac_us*1000;

}								    

#line 88 "..\\SYSTEM\\delay\\delay.c"
