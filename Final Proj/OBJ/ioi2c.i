...
#line 3 "..\\HARDWARE\\IIC\\IOI2C.c"
#line 4 "..\\HARDWARE\\IIC\\IOI2C.c"
...
{			
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH&=0XFFFFFF00;
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH|=0X00000033;	   
}
...
int IIC_Start(void)
{
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH&=0XFFFFFF0F;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH|=3<<4;};     
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(9<<2))))=1;
	if(! *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) &0xFFFFF)<<5)+(9<<2)))))return 0;	
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(8<<2))))=1;
	delay_us(1);
 	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(9<<2))))=0;
	if(*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) &0xFFFFF)<<5)+(9<<2)))))return 0;
	delay_us(1);
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(8<<2))))=0;
	return 1;
}
...
{
	u8 ucErrTime=0;
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH&=0XFFFFFF0F;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->CRH|=8<<4;};      
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(9<<2))))=1;
	delay_us(1);	   
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(8<<2))))=1;
	delay_us(1);	 
	while(*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) &0xFFFFF)<<5)+(9<<2)))))
	{
		ucErrTime++;
		if(ucErrTime>50)
		{
...
{                        
    ...
    *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(8<<2))))=0;
    for(t=0;t<8;t++)
    {              
        *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(9<<2))))=(txd&0x80)>>7;
        txd<<=1; 	  
		delay_us(1);   
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(8<<2))))=1;
		delay_us(1); 
...
u8 IIC_Read_Byte(unsigned char ack)
{
    ...
    for(i=0;i<8;i++ )
	{
		...
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+12) &0xFFFFF)<<5)+(8<<2))))=1;
        receive<<=1;
        if(*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x0C00)+8) &0xFFFFF)<<5)+(9<<2)))))receive++;   
		delay_us(2); 
    }					 
    if (ack)
        IIC_Ack(); 
